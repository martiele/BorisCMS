<?php
	...
	// Preview options
//	$mcImageManagerConfig['preview.wwwroot'] = 'D:\\Inetpub\\webs\\alberghieromontecatiniit'; // absolute or relative from this script path, try to leave blank system figures it out.
	...
	$mcImageManagerConfig['filesystem.path'] = '../../../../../public/files'; // absolute or relative from this script path, optional.
	$mcImageManagerConfig['filesystem.rootpath'] = '../../../../../public/files'; // absolute or relative from this script path, required.
