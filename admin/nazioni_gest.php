...
mysqli_select_db($std_conn, $database_std_conn);
$query_Recordset1 = sprintf("SELECT dny_nazione.*, dny_gruppo_spedizione.nome gruppo FROM %s JOIN dny_gruppo_spedizione ON dny_nazione.id_gruppo_spedizione = dny_gruppo_spedizione.id WHERE dny_nazione.deleted=0 ORDER BY dny_nazione.ordinamento ASC", 
					$tabella);
...
<html xmlns="http://www.w3.org/1999/xhtml"> 
	<head>
		...
		<title><?php echo $_SESSION["www_title"]; ?> - Nazioni</title>
				...
				<div class="content-box-content">
					...
					<div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
						...
						<div class="notification attention png_bg">
							<a href="#" class="close"><img src="resources/images/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
							<div>
								Tramite la tabella sottostante puoi inserire / modificare / eliminare l'elenco dei gruppi di spedizione.</div>
						</div>
...
?>
  ...
  <tr>
    ...
    <td><?php echo $row_Recordset1['codice_nazione']; ?></td>
    <td><?php echo ($row_Recordset1['applica_iva']=="1")?"S&Igrave;":"No"; ?></td>
    <td><a href="provincie_gest.php?nazione=<?php echo $row_Recordset1['id']; ?>">gestisci</a></td>
