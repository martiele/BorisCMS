...
if($_GET["orderby"]!=""){
	...
	}else if($_GET["orderby"]=="newsletter") { $orderby="acconsento_newsletter DESC"; 
	}
}
mysqli_select_db($std_conn, $database_std_conn);
$query_Recordset1 = sprintf("SELECT * FROM %s WHERE deleted=0 ORDER BY %s", $tabella, $orderby);
...
<html xmlns="http://www.w3.org/1999/xhtml"> 
	<head>
		...
		<title><?php echo $_SESSION["www_title"]; ?> - Elenco Clienti</title>
				...
				<div class="content-box-content">
					...
					<div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
						...
						<table>
							...
							<thead>
								<tr>
                                	<th><a href="<?php echo $sufx_sezione; ?>_gest.php?orderby=id">Cod.</a></th>
	                                <th><a href="<?php echo $sufx_sezione; ?>_gest.php?orderby=nome">Nome</a></th>
	                                <th><a href="<?php echo $sufx_sezione; ?>_gest.php?orderby=cognome">Cognome</a></th>
	                                <th><a href="<?php echo $sufx_sezione; ?>_gest.php?orderby=email">Email</a></th>
	                                <th><a href="<?php echo $sufx_sezione; ?>_gest.php?orderby=newsletter">Newsletter</a></th>
	                                <th>&nbsp;</th>
								</tr>
...
?>
  ...
  <tr>
    ...
    <td><?php echo ($row_Recordset1['acconsento_newsletter']=="1")?"S&igrave;":"No"; ?></td>
    <td>
      <!-- Icons -->
      <a href="<?php echo $sufx_sezione; ?>_details.php?id=<?php echo $row_Recordset1['id']; ?>" title="Edit"><img src="resources/images/icons/pencil.png" alt="Edit" /></a>
