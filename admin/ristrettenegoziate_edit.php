...
<span class="textfieldInvalidFormatMsg">Formato non valido.</span></span><br /><small>Es: http://www.bandobando.it/pagina.html</small>
                ...
                <p>
                	...
                	<select name="tipo_procedura" id="tipo_procedura">
                    	<option value="" <?php if (!(strcmp($row_Recordset1['tipo_procedura'],""))) {echo "selected=\"selected\"";} ?> >---------</option>
                    	<option value="Ristretta" <?php if (!(strcmp($row_Recordset1['tipo_procedura'],"Ristretta"))) {echo "selected=\"selected\"";} ?> >Ristretta</option>
                        <option value="Negoziata" <?php if (!(strcmp($row_Recordset1['tipo_procedura'],"Negoziata"))) {echo "selected=\"selected\"";} ?> >Negoziata</option>
                    </select>
                </p>
