...
if($_POST["nomeform"]=="vv"){
	...
	$insertSQL = sprintf("INSERT INTO %s (%s, nome, codice_provincia, id_gruppo_spedizione) VALUES (%s, %s, %s, %s)",
			   $tabella,
			   $label_id_padre,
...
<html xmlns="http://www.w3.org/1999/xhtml"> 
	<head>
		...
		<title><?php echo $_SESSION["www_title"]; ?> - Aggiungi soglia Prezzo/Peso</title>
		...
		<div id="insert-content"> <!-- Main Content Section with everything -->
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<h3>Aggiunta soglia Prezzo/Peso</h3>
                    <ul class="content-box-tabs">
						<li><a href="#tab1" class="default-tab">Aggiunta soglia Prezzo/Peso</a></li>
					</ul>
				  <div class="clear"></div>
					...
					<div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
							  ...
							  <p>
								...
								<input class="text-input small-input" type="text" id="codice_provincia" name="codice_provincia" />
								<span class="textfieldRequiredMsg input-notification error png_bg">È obbligatorio specificare un valore.</span></span>
