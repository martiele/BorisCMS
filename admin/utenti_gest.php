...
mysqli_select_db($std_conn, $database_std_conn);
$query_Recordset1 = sprintf("SELECT * FROM %s WHERE deleted=0 AND level>=%s AND level<=3 ORDER BY %s ASC", $tabella, $_SESSION['MM_UserGroup'], $orderby);
...
<html xmlns="http://www.w3.org/1999/xhtml"> 
	<head>
		...
		<title><?php echo $_SESSION["www_title"]; ?> - Utenti</title>
