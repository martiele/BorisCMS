...
if( (isset($_POST["riordina"])) && ($_POST["riordina"]=="1") ){
	mysqli_select_db($std_conn, $database_std_conn);
	$query_rs_aggiorna_ordine = sprintf("SELECT * FROM %s WHERE deleted = 0 AND level=4 ORDER BY ordinamento ASC",$tabella);
...
if($_GET["orderby"]!=""){
	...
	}else if($_GET["orderby"]=="level") { $orderby="level"; 
	}
}
mysqli_select_db($std_conn, $database_std_conn);
$query_Recordset1 = sprintf("SELECT * FROM %s WHERE deleted=0 AND level=4 ORDER BY %s ASC", $tabella, $orderby);
...
<html xmlns="http://www.w3.org/1999/xhtml"> 
	<head>
		...
		<title><?php echo $_SESSION["www_title"]; ?> - Elenco Negozianti</title>
				...
				<div class="content-box-content">
					...
					<div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
						...
						<div class="notification attention png_bg">
							<a href="#" class="close"><img src="resources/images/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
							<div>
								Tramite la tabella sottostante puoi inserire / modificare / eliminare gli utenti che possono accedere all'area negozianti.</div>
						</div>
						...
						<table>
							...
							<thead>
								<tr>
	                                ...
	                                <th><a href="<?php echo $sufx_sezione; ?>_gest.php?<?=$padre_get_post?>=<?=$id_padre?>&orderby=level">Tipologia</a></th>
	                                <th>Negozio</th>
	                                <th>&nbsp;</th>
								</tr>
...
?>
  ...
  <tr <?php if($row_Recordset1['is_attivo']==0){ echo 'class="not_attivo"'; } ?>>
	...
	?></td>
    <td><?php if($row_Recordset1['level']==4){ echo $row_Recordset1['negozio']; } ?></td>
    <td>
      <!-- Icons -->
