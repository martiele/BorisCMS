...
if($_GET["orderby"]!=""){
	...
	}else if($_GET["orderby"]=="metodo") { $orderby="metodo ASC"; 
...
mysqli_select_db($std_conn, $database_std_conn);
$query_Recordset1 = sprintf("SELECT * FROM %s ORDER BY %s", $tabella, $orderby);
...
<html xmlns="http://www.w3.org/1999/xhtml"> 
	<head>
		...
		<title><?php echo $_SESSION["www_title"]; ?> - Ordini Clienti</title>
				...
				<div class="content-box-content">
					...
					<div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
						...
						<div class="notification attention png_bg">
							<a href="#" class="close"><img src="resources/images/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
							<div>
								Tramite la tabella sottostante puoi consultare e gestire gli ordini effettuati e/o intrapresi dal cliente.</div>
						</div>
						...
						<table>
							...
							<thead>
								<tr>
	                                ...
	                                <th><a href="<?php echo $sufx_sezione; ?>_gest.php?<?=$padre_get_post?>=<?=$id_padre?>&orderby=metodo">Metodo</a></th>
	                                <th>Totale</th>
	                                <th>&nbsp;</th>
								</tr>
...
?>
  ...
  <tr>
    ...
    <td><?php echo $row_Recordset1['nome']." ".$row_Recordset1['cognome']; ?></td>
	...
	?></td>
    <td><?php 
		switch($row_Recordset1['metodo']){
			case 1: echo "PayPal"; break;
			case 2: echo "UNICREDIT"; break;
			case 3: echo "Bonifico"; break;
			case 4: echo "Contrassegno"; break;
		}
	?></td>
