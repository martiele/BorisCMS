...
if($_GET["orderby"]!=""){
	...
	}else if($_GET["orderby"]=="valore") { $orderby="valore"; 
	}
}
mysqli_select_db($std_conn, $database_std_conn);
...
<html xmlns="http://www.w3.org/1999/xhtml"> 
	<head>
		...
		<title><?php echo $_SESSION["www_title"]; ?> - Settings</title>
						...
						<table>
							...
							<thead>
								<tr>
								   ...
								   <th colspan="2"><a href="<?php echo $sufx_sezione; ?>_gest.php?orderby=nome">Nome</a></th>
								   <th colspan="2"><a href="<?php echo $sufx_sezione; ?>_gest.php?orderby=valore">Valore</a></th>
								   <th>&nbsp;</th>
								</tr>
...
?>
  ...
  <tr>
    ...
    <td colspan="2"><?php echo $row_Recordset1['valore']; ?></td>
    <td>
      <!-- Icons -->
