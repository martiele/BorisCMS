		...
		<div id="insert-content"> <!-- Main Content Section with everything -->
			...
			<div class="content-box"><!-- Start Content Box -->
					...
					<div class="tab-content <?php echo ($i == $_SESSION["linguadefault"])?'default-tab':''; ?>" id="tab<?=$i?>"> <!-- This is the target div. id must match the href of this div's tab -->
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
							  ...
							  <p>
								...
								<input class="text-input medium-input" type="text" id="descrizione<?=$i?>" name="descrizione<?=$i?>" />
                ...
                <p>
                  ...
                  <input type="hidden" id="color_code" name="color_code" value="#000000" />
                  <!--
                ...
                <p>
                    <input class="button" type="submit" value="Inserisci" />&nbsp;&nbsp;<input class="button" type="button" value="Chiudi" onclick="javascript:location.href='<?php echo $sufx_sezione; ?>_gest.php?<?=$padre_get_post?>=<?=$id_padre?>';" />
                </p>
            </form>			
