...
if( (isset($_POST["riordina"])) && ($_POST["riordina"]=="1") ){
	...
	if($totalRows_rs_aggiorna_ordine>0){
		do{
			$ordine = (float)(str_replace(",",".",$_POST["ordinamento".$row_rs_aggiorna_ordine["id"]]));
			if($ordine>0){
				$updateSQL = sprintf("UPDATE %s SET ordinamento=%s WHERE id=%s LIMIT 1", $tabella,
				   GetSQLValueString($ordine, "double"),
...
mysqli_select_db($std_conn, $database_std_conn);
$query_Recordset1 = sprintf("SELECT A.*, B.nome FROM (%s as A LEFT JOIN %s as B ON A.id = B.id_ref) WHERE A.deleted=0 AND (B.id_lingua=%s OR B.id_lingua is Null) ORDER BY A.ordinamento ASC", 
					$tabella,
					$tabella."_lingua",
...
<html xmlns="http://www.w3.org/1999/xhtml"> 
	<head>
		...
		<title><?php echo $_SESSION["www_title"]; ?> - Lookbook</title>
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<h3>Elenco composizioni Lookbook</h3>
				...
				<div class="content-box-content">
					...
					<div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
						...
						<div class="notification attention png_bg">
							<a href="#" class="close"><img src="resources/images/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
							<div>
								Tramite la tabella sottostante puoi inserire / modificare / eliminare l'elenco delle composizioni per il Lookbook.</div>
						</div>
...
?>
  ...
  <tr <?php if (!(strcmp($row_Recordset1['is_attivo'],"0"))) {echo 'class="not_attivo"';} ?>>
    ...
    <td style="padding:2px; position:relative;">
		<?php
        $colname_rs_fotoprodotto = $row_Recordset1['id'];
        mysqli_select_db($std_conn, $database_std_conn);
	...
	?>
				<img src="<?php echo $filesmall; ?>" border="0" height="60" style="position:relative; top:6px;" />
	<?php
	        }
        }
    ...
    <td><a href="foto_lookbook_gest.php?prodotto=<?php echo $row_Recordset1['id']; ?>">amministra foto</a></td>
    <td>
      <!-- Icons -->
