...
mysqli_select_db($std_conn, $database_std_conn);
$query_Recordset1 = sprintf("SELECT * FROM %s WHERE deleted=0 ORDER BY ordinamento ASC", 
					$tabella);
...
<html xmlns="http://www.w3.org/1999/xhtml"> 
	<head>
		...
		<title><?php echo $_SESSION["www_title"]; ?> - Pacchi e Confezioni</title>
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<h3>Elenco Pacchi e Confezioni</h3>
				...
				<div class="content-box-content">
					...
					<div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
						...
						<div class="notification attention png_bg">
							<a href="#" class="close"><img src="resources/images/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
							<div>
								Tramite la tabella sottostante puoi inserire / modificare / eliminare l'elenco dei pacchi disponibili per la spedizione.</div>
						</div>
                        
                        <div class="notification error png_bg">
                            <a href="#" class="close"><img src="resources/images/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
                            <div>
                                <b>ATTENZIONE! E' importante che l'ordine dei pacchi in questa pagina sia impostata secondo il VOLUME, partendo dalla scatola piu' piccola fino a quella piu' grande!.</b>
                            </div>
                        </div>
...
?>
  ...
  <tr>
    ...
    <td><?php echo $row_Recordset1['lu']; ?> x <?php echo $row_Recordset1['la']; ?> x <?php echo $row_Recordset1['al']; ?> cm</td>
    <td>
      <!-- Icons -->
