...
<html xmlns="http://www.w3.org/1999/xhtml"> 
	<head>
		...
		<title><?php echo $_SESSION["www_title"]; ?> - Aggiungi Impostazione</title>
		...
		<div id="insert-content"> <!-- Main Content Section with everything -->
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<h3>Aggiunta Impostazione</h3>
					
					<ul class="content-box-tabs">
						<li><a href="#tab1" class="default-tab">Aggiunta Impostazione</a></li>
					</ul>
       	...
       	<input type="hidden" name="nomeform" value="vv" />
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
							  ...
							  <p>
								<label>Valore</label>
								<input class="text-input medium-input" type="text" id="valore" name="valore" />
