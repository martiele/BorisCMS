...
mysqli_select_db($std_conn, $database_std_conn);
$query_Recordset1 = sprintf("SELECT A.*, B.nome, B.descrizione FROM (%s as A LEFT JOIN %s as B ON A.id = B.id_ref) WHERE A.deleted=0 AND A.%s=%s AND (B.id_lingua=%s OR B.id_lingua is Null) ORDER BY A.ordinamento ASC", 
					$tabella,
					$tabella."_lingua",
					$label_id_padre,
...
<html xmlns="http://www.w3.org/1999/xhtml"> 
	<head>
		...
		<title><?php echo $_SESSION["www_title"]; ?> - Categorie</title>
				...
				<div class="content-box-content">
					...
					<div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
						...
						<div class="notification attention png_bg">
							<a href="#" class="close"><img src="resources/images/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
							<div>
								Tramite la tabella sottostante puoi inserire / modificare / eliminare l'elenco delle categorie dei prodotti del sito.</div>
						</div>
...
?>
  ...
  <tr <?php if (!(strcmp($row_Recordset1['is_attivo'],"0"))) {echo 'class="not_attivo"';} ?>>
	...
	<?php
        ...
        $nomefilesmall = $row_Recordset1["nomefilesmall"];
        $filesmall = $_SESSION["path_upload_admin"].$_SESSION["path_foto_collezioni"].$_SESSION["path_fotosmall_prodotto"].$nomefilesmall;
    ...
    <td><?php echo $row_Recordset1['descrizione']; ?></td>
    <td>
      <!-- Icons -->
