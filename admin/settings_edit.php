...
$sufx_sezione="settings";
$tabella = "dny_site_setting";
...
if($_POST["nomeform"]=="vv"){
	$insertSQL = sprintf("UPDATE %s SET nome=%s, valore=%s WHERE id=%s",
			   $tabella,
...
<html xmlns="http://www.w3.org/1999/xhtml"> 
	<head>
		...
		<title><?php echo $_SESSION["www_title"]; ?> - Modifica Impostazione</title>
		...
		<div id="insert-content"> <!-- Main Content Section with everything -->
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<h3>Modifica Impostazione</h3>
					
					<ul class="content-box-tabs">
						<li><a href="#tab1" class="default-tab">Modifica Impostazione</a></li>
					</ul>
                ...
                <input type="hidden" name="id" value="<?php echo $_GET["id"]; ?>" />
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
							  ...
							  <p>
								<label>Valore</label>
								<input class="text-input medium-input" type="text" id="valore" name="valore" value="<?php echo $row_Recordset1["valore"]; ?>" />
                                <br /><small>Es: I Viaggi Web</small>
							  </p>                                
