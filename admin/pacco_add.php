...
if($_POST["nomeform"]=="vv"){
	...
	$insertSQL = sprintf("INSERT INTO %s (nome, lu, la, al, ordinamento) VALUES (%s, %s, %s, %s, %s)",
			   $tabella,
			   GetSQLValueString($_POST['nome'], "text"),
			   GetSQLValueString($_POST['lu'], "int"),
			   GetSQLValueString($_POST['la'], "int"),
			   GetSQLValueString($_POST['al'], "int"),
...
<html xmlns="http://www.w3.org/1999/xhtml"> 
	<head>
		...
		<title><?php echo $_SESSION["www_title"]; ?> - Aggiungi tipologia pacco</title>
		...
		<div id="insert-content"> <!-- Main Content Section with everything -->
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<h3>Aggiunta tipologia pacco</h3>
					
					<ul class="content-box-tabs">
						<li><a href="#tab1" class="default-tab">Aggiunta tipologia pacco</a></li>
					</ul>
       	...
       	<input type="hidden" name="nomeform" value="vv" />
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
							  ...
							  <p>
                                ...
                                <input class="text-input small-input" type="text" id="lu" name="lu" />
							  ...
							  <p>
                                ...
                                <input class="text-input small-input" type="text" id="la" name="la" />
                                <span class="textfieldRequiredMsg">È obbligatorio specificare un valore.</span><span class="textfieldInvalidFormatMsg">Formato non valido.</span></span></p>		

							  <p>
								<label>Altezza</label>
								<span id="sprytextfield4">
                                <input class="text-input small-input" type="text" id="al" name="al" />
                                <span class="textfieldRequiredMsg">È obbligatorio specificare un valore.</span><span class="textfieldInvalidFormatMsg">Formato non valido.</span></span></p>		
