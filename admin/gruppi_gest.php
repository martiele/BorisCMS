...
<html xmlns="http://www.w3.org/1999/xhtml"> 
	<head>
		...
		<title><?php echo $_SESSION["www_title"]; ?> - Gruppi Spedizione</title>
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<h3>Elenco Gruppi Spedizione</h3>
...
?>
  ...
  <tr>
    ...
    <td><a href="soglie_gest.php?gruppo=<?php echo $row_Recordset1['id']; ?>">gestisci imballaggi</a></td>
