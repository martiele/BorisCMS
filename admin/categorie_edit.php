	...
	<body><div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
		...
		<div id="insert-content"> <!-- Main Content Section with everything -->
            ...
            <p>
                ...
                <input type="checkbox" name="mostra_dati_sensibili" value="1" <?php if (!(strcmp($row_Recordset1['mostra_dati_sensibili'],"1"))) {echo "checked=\"checked\"";} ?> /> categoria riservata ai soli utenti abilitati alla visualizzazione dei dati sensibili.
            </p>	 		
            <p>
