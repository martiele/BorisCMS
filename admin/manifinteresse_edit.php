...
<html xmlns="http://www.w3.org/1999/xhtml"> 
	<head>
		...
		<title><?php echo $_SESSION["www_title"]; ?> - Modifica Manifestazione di Interesse</title>
		...
		<div id="insert-content"> <!-- Main Content Section with everything -->
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<h3>Modifica Manifestazione di Interesse</h3>
					
					<ul class="content-box-tabs">
						<li><a href="#tab1" class="default-tab">Modifica Manifestazione di Interesse</a></li>
					</ul>
...
?>   								
							  ...
							  <p>
                                ...
                                <textarea class="text-input medium-input" id="OggettoGara" name="OggettoGara"><?php echo $row_Recordset1["OggettoGara"]; ?></textarea>						
                                <br /><small>Es: Lavori di manutenzione delle strade comunali per l'anno 2013</small>
							  </p>	 

							  <p>
								<label>Scadenza</label>
                                <input type="text" class="text-input small-input" id="Scad" name="Scad" value="<?php echo $row_Recordset1["Scad"]; ?>" />				
                                <br /><small>Es: 01 GEN - 13:00</small>
							  </p>	 

							  <p>
								<label>Esito</label>
                                <input type="text" class="text-input small-input" id="SiNo" name="SiNo" value="<?php echo $row_Recordset1["SiNo"]; ?>" />
							  ...
							  <p>
                                ...
                                <input type="text" class="text-input medium-input" id="consorziate_indicate" name="consorziate_indicate" value="<?php echo $row_Recordset1["consorziate_indicate"]; ?>" />
							  </p>	 
							  ...
							  <p>
								<label>Link alla Gara nella sezione Ristrette/Negoziate</label>
									...
									?>
                                <input type="text" class="text-input medium-input" id="link_gara" name="link_gara" value="<?php echo $row_Recordset1["link_gara"]; ?>" placeholder="http://" />
