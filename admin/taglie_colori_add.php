...
if($_POST["nomeform"]=="vv"){
	...
	$insertSQL = sprintf("INSERT INTO %s (%s, ordinamento, is_attivo, cod_attr, taglia, colore, color_code, qta, extra, extra_negozi, is_attivo_negozi) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
			   $tabella,
			   $label_id_padre,
			   GetSQLValueString($id_padre, "int"),
	...
	//resto qui per ulteriori inserimenti
...
<html xmlns="http://www.w3.org/1999/xhtml"> 
	<head>
		...
		<title><?php echo $_SESSION["www_title"]; ?> - Aggiungi Variante Taglia/Colore</title>
	...
	<body><div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
		...
		<div id="insert-content"> <!-- Main Content Section with everything -->
			...
			<script type="text/javascript"><!--//
                <?php if($did_post){ ?>
                alert('Variante inserita con successo!');
                <?php } ?>
            //--></script>
		...
		echo '<body style="background-image:none;"><div id="body-wrapper"><div id="insert-content" style="background-image:none; margin:3px; padding:0px;">';
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<h3>Aggiunta variante Taglia / Colore</h3>
					...
					<div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
							  ...
							  <p>
								...
								<input class="text-input small-input" type="text" id="cod_attr" name="cod_attr" />
...
Se specificato viene riportato nella conferma d'ordine insieme al codice prodotto ed identifica la variante taglia/colore</small>
							  ...
							  <p>
								<label>Taglia</label>
								<input class="text-input small-input" type="text" id="taglia" name="taglia" value="<?=$_POST["taglia"]?>" /> 
							  ...
							  <p>
								...
								<input class="text-input small-input" type="text" id="colore" name="colore" value="<?=$_POST["colore"]?>" />
...
<strong>Lasciando vuoto il NOME del colore, verrà ignorato anche il codice colore selezionato sotto!</strong></small>
                                ...
                                <div id="customWidget">
                                    <div id="colorSelector2"><div style="background-color: <?=$_POST["color_code"]?>"></div></div>
                                    <div id="colorpickerHolder2">
                                    </div>
                                </div>
                              <input type="hidden" id="color_code" name="color_code" value="<?=$_POST["color_code"]?>" />
							  </p>	
							  ...
							  <p>
                                ...
                                <input class="text-input small-input" type="text" id="qta" name="qta" value="1" />
            ...
            <input class="text-input small-input" type="text" id="extra" name="extra" value="<?=(($_POST["extra"]!="")?$_POST["extra"]:"0,00")?>" />
...
Consente di indicare un sovrapprezzo o un sottoprezzo rispetto al valore standard per questa specifica versione di taglia/colore.</small>
            ...
            <input class="text-input small-input" id="extra_negozi" name="extra_negozi" value="<?=(($_POST["extra_negozi"]!="")?$_POST["extra_negozi"]:"0,00")?>" />
            <span class="textfieldRequiredMsg">È obbligatorio specificare un valore.</span><span class="textfieldInvalidFormatMsg">Formato non valido.</span></span>&euro;
                    <br /><small>Es: 12,40 oppure -8,40<br />
Consente di indicare un sovrapprezzo o un sottoprezzo rispetto al valore standard per questa specifica versione di taglia/colore.</small>
                </p>	
                ...
                <label>Mostra in area riservata dei negozi</label>
                    ...
                    <input type="checkbox" name="is_attivo_negozi" value="1" checked="checked" /> 
            ...
            <div class="clear"></div>
                                ...
                                <p>
                                <input class="button" type="submit" value="Inserisci" onclick="javascript:tenta();" />&nbsp;&nbsp;
                                <?php if(!$noframe){ ?>	
                                <input class="button" type="button" value="Annulla" onclick="javascript:location.href='<?php echo $sufx_sezione; ?>_gest.php?<?=$padre_get_post?>=<?=$id_padre?>';" />
                                    <?php } ?>
