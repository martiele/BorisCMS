...
mysqli_select_db($std_conn, $database_std_conn);
$query_Recordset1 = sprintf("SELECT %s.*, dny_pacco.nome nome_pacco FROM %s JOIN dny_pacco ON %s.id_pacco = dny_pacco.id WHERE %s.deleted=0 AND dny_pacco.deleted=0 AND %s=%s ORDER BY dny_pacco.ordinamento ASC", 
					$tabella,
					$tabella,
					$tabella,
					$tabella,
...
<html xmlns="http://www.w3.org/1999/xhtml"> 
	<head>
		...
		<title><?php echo $_SESSION["www_title"]; ?> - Elenco Soglie Prezzo/Pacco</title>
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<h3>Elenco Soglie Prezzo/Pacco</h3>
					
					<ul class="content-box-tabs">
						<li><a href="#tab1" class="default-tab">Elenco Soglie Prezzo/Pacco</a></li>
					</ul>
...
?>
    <?php do { ?>
  <tr>
    <td><?php echo $row_Recordset1['nome_pacco']; ?></td>
