...
?>
                              ...
                              <p>
                                ...
                                <input type="checkbox" name="accesso_completo" value="1" checked="checked" /> Se deselezionato, l'utente potrà accedere solo all'elenco delle gare in corso, MA NON alle altre sezioni dell'area riservata.
                              </p>
                              <p>
                                <label>Mostra SOLO dati sensibili</label>                
                                <input type="checkbox" name="mostra_dati_sensibili" value="1" /> Se selezionato, l'utente potrà accedere solo ai documenti elencati nella categoria "Documentazione Consorzio".
                              </p>
