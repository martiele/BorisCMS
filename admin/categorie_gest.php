						...
						<table>
							...
							<thead>
								<tr>
	                                ...
	                                <th>Gestione</th>
	                                <th>Categoria</th>
	                                <th style="text-align:center;">Dati Sensibili</th>
	                                <th>&nbsp;</th>
								</tr>
...
?>
  ...
  <tr <?php if (!(strcmp($row_Recordset1['is_attivo'],"0"))) {echo 'class="not_attivo"';} ?>>
    ...
    <td><a href="sottocategorie_gest.php?categoria=<?php echo $row_Recordset1['id']; ?>">sottocategorie</a></td>
    <td><?php echo $row_Recordset1['nome']; ?></td>
    <td style="text-align:center;"><?php echo ($row_Recordset1['mostra_dati_sensibili']==1)?"Sì":"-"; ?></td>
    <td>
      <!-- Icons -->
